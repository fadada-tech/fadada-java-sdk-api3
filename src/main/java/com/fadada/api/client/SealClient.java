...
public class SealClient {
     ...
     * @return
     */
    public BaseRsp<AddCompanySealRsp> addCompanySeal(AddCompanySealReq req, File imageFile) throws ApiException {
        ...
        return fadadaApiClient.invokeAPI(req, ADD_COMPANY_SEAL, files, AddCompanySealRsp.class);
    }
     ...
     * @return
     */
    public BaseRsp delCompanySeal(DelCompanySealReq req) throws ApiException {
        PreconditionsUtil.checkObject(req);
        return fadadaApiClient.invokeAPI(req, DEL_COMPANY_SEAL, Object.class);
    }
     ...
     * @return
     */
    public BaseRsp sealAuth(SealAuthReq req) throws ApiException {
        PreconditionsUtil.checkObject(req);
        return fadadaApiClient.invokeAPI(req, SEAL_AUTH, Object.class);
    }
     ...
     * @return
     */
    public BaseRsp cancelSealAuth(CancelSealAuthReq req) throws ApiException {
        PreconditionsUtil.checkObject(req);
        return fadadaApiClient.invokeAPI(req, CANCEL_SEAL_AUTH, Object.class);
    }
     ...
     * @return
     */
    public BaseRsp<CompanySealListRsp> companySealList(CompanySealListReq req) throws ApiException {
        PreconditionsUtil.checkObject(req);
        return fadadaApiClient.invokeAPI(req, COMPANY_SEAL_LIST, CompanySealListRsp.class);
    }
     ...
     * @return
     */
    public BaseRsp<CompanySealDetailRsp> companySealDetail(CompanySealDetailReq req) throws ApiException {
        PreconditionsUtil.checkObject(req);
        return fadadaApiClient.invokeAPI(req, COMPANY_SEAL_DETAIL, CompanySealDetailRsp.class);
    }
}
