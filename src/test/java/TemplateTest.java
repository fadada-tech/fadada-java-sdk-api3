...
public class TemplateTest extends BaseTest {
    ...
    // 本地
//    private String templateId = "1599637977837199671";
...
//        templateTest.createByTemplate();
    ...
    private void uploadCompanyTemplateFile() throws ApiException {
        ...
        req.setFileType(1, null);
        File file = new File("C:\\Users\\yangh1\\Desktop\\工作\\福州基础服务SITUAT环境CICD信息.pdf");
        BaseRsp<UploadCompanyTemplateFileRsp> result = templateClient.uploadCompanyTemplateFile(token, req, file);
    ...
    private void updateCompanyTemplate() throws ApiException {
        ...
        target1.setRoleName("DBA2ik");
        target1.setTargetId("1599473947764150097");
        target1.setRoleType(1);
        ...
        BaseRsp<UpdateCompanyTemplateRsp> result = templateClient.updateCompanyTemplate(token, req);
    ...
    private void getEditCompanyTemplateUrl() throws ApiException {
        ...
        BaseRsp<GetEditCompanyTemplateUrlRsp> result = templateClient.getEditCompanyTemplateUrl(token, req);
        System.out.println(result.toString());
    }
    ...
    private void delCompanyTemplateFile() throws ApiException {
        ...
        BaseRsp baseRsp = templateClient.delCompanyTemplateFile(token, req);
    ...
    private void getCompanyTemplatePreviewUrl() throws ApiException {
        GetEditCompanyTemplateUrlReq req = new GetEditCompanyTemplateUrlReq();
        req.setTemplateId(templateId);
        BaseRsp<GetCompanyTemplatePreviewUrlRsp> result = templateClient.getCompanyTemplatePreviewUrl(token, req);
        System.out.println(result.toString());
    }
    ...
    private void queryCompanyTemplateList() throws ApiException {
        ...
        BaseRsp<QueryCompanyTemplateListRsp> result = templateClient.queryCompanyTemplateList(token, req);
        System.out.println(result.toString());
    }
    ...
    private void downloadCompanyTemplateFile() throws ApiException {
        ...
        templateInfo.setTemplateId(templateId);
        req.setTemplateInfo(templateInfo);
        BaseRsp<DownLoadFileRsp> result = templateClient.downloadCompanyTemplateFile(token, req);
        if (result.isSuccess()) {
...
//        t1.setTemplateFileId("1585382593389145558");
        t1.setTemplateFileId("1600065270728129444");
